import { Constructor, Editor, ItemView, Modal, Plugin, TFile } from "obsidian";
 ...
 */
export declare function getAvailablePathForAttachments(fileName: string, format: string, sourceFile: TFile): string;
/**
 ...
 */
export declare function getSelectionFromCurrFile(cached?: boolean): Promise<string | null>;
/**
 ...
 * @returns boolean
 */
export declare const isInVault: (noteName: string, sourcePath?: string) => boolean;
/**
 ...
 */
export declare function createNewMDNote(newName: string, currFilePath?: string): Promise<TFile>;
/**
 ...
 * @returns Promise
 */
export declare function openOrSwitch(dest: string, event: MouseEvent, options?: {
 ...
 * @returns boolean
 */
export declare function isResolved(to: string, from: string): boolean;
/**
 ...
 */
export declare function openView<YourView extends ItemView>(viewType: string, viewClass: Constructor<YourView>, side?: "left" | "right"): Promise<YourView>;
/**
 ...
 */
export declare function saveViewSide<YourPlugin extends Plugin>(plugin: YourPlugin, viewType: string, settingName: string): Promise<"left" | "right">;
/**
 ...
 */
export declare function addRenderedMarkdownButton<YourPlugin extends Plugin>(plugin: YourPlugin, containerEl: HTMLElement, source: string, fetch: boolean, displayText: string): void;
/**
 ...
 * @returns {boolean}
 */
export declare function resolvedLinksComplete(noFiles: number): boolean;
/**
 ...
 */
export declare function waitForResolvedLinks(delay?: number, max?: number): Promise<void>;
/**
 ...
 * @returns
 */
export declare function getActiveFileContent(cached?: boolean): Promise<string | null>;
